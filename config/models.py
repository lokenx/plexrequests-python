...
class Config(models.Model):
    ...
    couchpotato_directory = models.CharField(max_length=255, default='')
    ...
    sickrage_directory = models.CharField(max_length=255, default='')
    ...
    sonarr_directory = models.CharField(max_length=255, default='')
